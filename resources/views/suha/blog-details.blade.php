...
<div>
     ...
     <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        <!-- Back Button-->
        <div class="back-button"><a href="{{ url ('blog-grid') }}">
    ...
    <div class="page-content-wrapper">
      <div class="blog-details-post-thumbnail" style="background-image: url('suha/dist/img/bg-img/6.jpg')">
        <div class="container">
      ...
      <div class="product-description pb-3">
        ...
        <div class="product-title-meta-data bg-white mb-3 py-3">
          <div class="container">
            ...
            <div class="post-meta-data d-flex align-items-center justify-content-between"><a class="d-flex align-items-center" href="#"><img src="suha/dist/img/bg-img/9.jpg" alt="">Sarah<span>Follow</span></a><span class="d-flex align-items-center">
