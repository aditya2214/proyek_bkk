      ...
      <div class="blog-wrapper py-3">
        <div class="container">
          <div class="section-heading d-flex align-items-center justify-content-between">
            <h6>Blog Grid</h6>
            <!-- Layout Options-->
            <div class="layout-options"><a class="active" href="blog-grid') }}"><i class="lni lni-grid-alt"></i></a><a href="{{ url ('blog-list') }}"><i class="lni lni-radio-button"></i></a></div>
          </div>
          <div class="row g-3">
            <!-- Single Blog Card-->
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card blog-card">
                <!-- Post Image-->
                <div class="post-img"><img src="suha/dist/img/bg-img/18.jpg" alt=""></div>
                ...
                <div class="post-content">
                  ...
                  <!-- Post Title--><a class="post-title d-block" href="blog-details') }}">The 5 best reviews in Suha</a>
                  <!-- Post Meta-->
                  ...
                  <!-- Read More Button--><a class="btn btn-primary btn-sm read-more-btn" href="blog-details') }}">Read More</a>
                </div>
              </div>
            </div>
            <!-- Single Blog Card-->
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card blog-card">
                <!-- Post Image-->
                <div class="post-img"><img src="suha/dist/img/bg-img/19.jpg" alt=""></div>
                <!-- Post Bookmark--><a class="post-bookmark" href="#"><i class="lni lni-bookmark"></i></a>
                <!-- Post Content-->
                <div class="post-content">
                  <div class="bg-shapes">
                  ...
                  <!-- Post Title--><a class="post-title d-block" href="blog-details') }}">The best deals of this week</a>
                  <!-- Post Meta-->
                  ...
                  <!-- Read More Button--><a class="btn btn-success btn-sm read-more-btn" href="blog-details') }}">Read for $0.7</a>
                </div>
              </div>
            </div>
            <!-- Single Blog Card-->
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card blog-card">
                <!-- Post Image-->
                <div class="post-img"><img src="suha/dist/img/bg-img/20.jpg" alt=""></div>
                <!-- Post Bookmark--><a class="post-bookmark" href="#"><i class="lni lni-bookmark"></i></a>
                <!-- Post Content-->
                <div class="post-content">
                  <div class="bg-shapes">
                  ...
                  <!-- Post Title--><a class="post-title d-block" href="blog-details') }}">5 tips for buy original products</a>
                  <!-- Post Meta-->
                  ...
                  <!-- Read More Button--><a class="btn btn-success btn-sm read-more-btn" href="blog-details') }}">Read for $0.9</a>
                </div>
              </div>
            </div>
            <!-- Single Blog Card-->
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card blog-card">
                <!-- Post Image-->
                <div class="post-img"><img src="suha/dist/img/bg-img/21.jpg" alt=""></div>
                <!-- Post Bookmark--><a class="post-bookmark" href="#"><i class="lni lni-bookmark"></i></a>
                <!-- Post Content-->
                <div class="post-content">
                  <div class="bg-shapes">
                  ...
                  <!-- Post Title--><a class="post-title d-block" href="blog-details') }}">Mega Deals: Up to 75% discount</a>
                  <!-- Post Meta-->
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card blog-card">
                <!-- Post Image-->
                <div class="post-img"><img src="suha/dist/img/bg-img/22.jpg" alt=""></div>
                <!-- Post Bookmark--><a class="post-bookmark" href="#"><i class="lni lni-bookmark"></i></a>
                <!-- Post Content-->
                <div class="post-content">
                  <div class="bg-shapes">
                  ...
                  <!-- Post Title--><a class="post-title d-block" href="blog-details') }}">Bridal shopping is the latest trends of this month</a>
                  <!-- Post Meta-->
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card blog-card">
                <!-- Post Image-->
                <div class="post-img"><img src="suha/dist/img/bg-img/23.jpg" alt=""></div>
                <!-- Post Bookmark--><a class="post-bookmark" href="#"><i class="lni lni-bookmark"></i></a>
                <!-- Post Content-->
                <div class="post-content">
                  <div class="bg-shapes">
                  ...
                  <!-- Post Title--><a class="post-title d-block" href="blog-details') }}">How to easily buy a product</a>
                  <!-- Post Meta-->
                  ...
                  <!-- Read More Button--><a class="btn btn-success btn-sm read-more-btn" href="blog-details') }}">Read for $0.2</a>
                </div>
              </div>
            </div>
          </div>
