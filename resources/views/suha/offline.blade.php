...
@section('content')
    ...
    <div class="suha-sidenav-wrapper" id="sidenavWrapper">
      ...
      <ul class="sidenav-nav ps-0">
        ...
        <li class="suha-dropdown-menu"><a href="{{ url ('#"><i class="lni lni-cart"></i>Shop Pages</a>
          <ul>
      ...
      <div class="container">
        ...
        <div class="offline-area-wrapper py-3 d-flex align-items-center justify-content-center">
          <div class="offline-text text-center"><img class="mb-4 px-5" src="img/bg-img/no-internet.png" alt="">
            ...
            <p>Seems like you're offline, please check your internet connection. This page doesn't support when you offline!</p><a class="btn btn-primary" href="{{ url ('home') }}">Back Home</a>
          </div>
        </div>
      </div>
    </div>
