          ...
          <div class="row g-3">
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card flash-sale-card">
                <div class="card-body"><a href="{{ url ('single-product') }}"><img src="suha/dist/img/product/1.png" alt=""><span class="product-title">Ceramic Planting Pot</span>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card flash-sale-card">
                <div class="card-body"><a href="{{ url ('single-product') }}"><img src="suha/dist/img/product/2.png" alt=""><span class="product-title">Fancy Sofa Set</span>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card flash-sale-card">
                <div class="card-body"><a href="{{ url ('single-product') }}"><img src="suha/dist/img/product/3.png" alt=""><span class="product-title">Classic Garden Chair</span>
